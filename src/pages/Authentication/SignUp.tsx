...
const SignUp: React.FC = () => {
  ...
  const handleRegistration = async (e: FormEvent<HTMLFormElement>) => {
    ...
    if (email === '' || name === '' || phone === '' || password === '') {
      ...
      try {
        setLoading(true);
        const response = await axios.post('https://crime-app-backend.vercel.app/api/v2/admin/register',{name,email,password,phone});
          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <Link className="mb-5.5 inline-block" to="/">
                <h1 className="text-3xl fonr-bold">CrimeUnit</h1>
              </Link>
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form onSubmit={handleRegistration} role='form'>
                ...
                <div className="mb-5">
                  <input
                    type="submit"
                    value={!loading ? "Create account":"creating account.."}
