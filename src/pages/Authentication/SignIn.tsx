    ...
    if (email === '' || password === '') {
      ...
      try {
        ...
        const response = await fetch(
          'https://crime-app-backend.vercel.app/api/v2/admin/login',
          {
            method: 'POST',
            headers: {
          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <Link className="mb-5.5 inline-block" to="/">
                ...
                <h1 className="text-3xl hidden dark:block">CrimeUnit</h1>
                <h1 className="text-3xl dark:hidden">CrimeUnit</h1>
              </Link>
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form role="form" onSubmit={handleLogin}>
                ...
                <div className="mb-5">
                  <input
                    type="submit"
                    value={!loading ? 'Sign In' : 'logging you in...'}
